...
public enum UpdatePurposeCommand implements Command {
    INSTANCE;

    private static final String PAGE_KEY = "updatePurposePage";
    ...
    public ResponseContext execute(RequestContext requestContext) {
        ...
        final String purposeId = requestContext.getParameter(Attributes.PURPOSE_ID);
        ...
        ResponseContext responseContext = validate(requestContext, exercise, equipment, food, purposeId);
    ...
    private ResponseContext validate(RequestContext requestContext, String exercise, String equipment, String food, String purposeId) {
        ...
        try {
            PURPOSE_SERVICE.updatePurpose(Integer.parseInt(purposeId), exercise, equipment, food);
