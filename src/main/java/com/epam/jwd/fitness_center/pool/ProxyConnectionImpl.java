...
public final class ProxyConnectionImpl implements ProxyConnection {

    private final static Logger LOGGER = LogManager.getLogger(ProxyConnectionImpl.class);

    private final Connection connection;

    public ProxyConnectionImpl(Connection connection) {
